    ...
    async def update(self):
        ...
        for car in self.cars:
            ...
            car.odometer = self._get_car_values(
                car_detail, car.finorvin, Odometer() if not car.odometer else car.odometer, ODOMETER_OPTIONS, False,"status")

            car.electric = self._get_car_values(
                car_detail, car.finorvin, Electric() if not car.electric else car.electric, ELECTRIC_OPTIONS, False,"precond")
